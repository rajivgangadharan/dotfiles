...
class AutofillOverlayIframeElement extends HTMLElement {
    constructor(iframePath, portName, initStyles, iframeTitle, ariaAlert) {
        super();
...
class AutofillOverlayButtonIframe extends autofill_overlay_iframe_element {
    constructor() {
        super("overlay/button.html", AutofillOverlayPort.Button, {
...
class AutofillOverlayContentService {
    ...
    createAutofillOverlayButton() {
        ...
        (_a = globalThis.customElements) === null || _a === void 0 ? void 0 : _a.define(customElementName, autofill_overlay_button_iframe);
    ...
    createAutofillOverlayList() {
        ...
        const customElementName = generateRandomCustomElementName();
        (_a = globalThis.customElements) === null || _a === void 0 ? void 0 : _a.define(customElementName, autofill_overlay_list_iframe);
