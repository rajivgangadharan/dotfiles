...
export DO_PAT=""
export PATH=$PATH:~/opt/terraform:/opt/atom:/home/rajivg/.cargo/bin:.
...
__conda_setup="$('/home/rajivg/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/rajivg/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/rajivg/anaconda3/etc/profile.d/conda.sh"
    else
...
# opencode
export PATH=/home/rajivg/.opencode/bin:$PATH
